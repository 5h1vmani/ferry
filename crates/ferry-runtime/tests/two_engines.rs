...
// Helpers for the QR pairing tests below.
...
// ---------------------------------------------------------------------------
// Item 12: QR pairing. The phone's camera screen is not built yet, so these
// test the engine half only: one engine calls `offer_scanned` with another
// engine's own `Offering` payload, exactly as the contract describes.
// ---------------------------------------------------------------------------
