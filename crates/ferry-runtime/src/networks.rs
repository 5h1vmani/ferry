...
/// [`apply_presence`] is what turns the answer into a browse loop that
...
/// turns both off itself, and [`apply_presence`] refuses to act once
...
/// acts on presence calls this, and [`apply_presence`] is what turns
